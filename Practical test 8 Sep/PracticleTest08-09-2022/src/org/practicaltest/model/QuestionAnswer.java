...
public class QuestionAnswer {
	...
	public QuestionAnswer(String question, String option1, String option2, String option3, String option4,String answer) {
	...
	public int hashCode() {
		return Objects.hash(answer, option1, option2, option3, option4, question);
	}
