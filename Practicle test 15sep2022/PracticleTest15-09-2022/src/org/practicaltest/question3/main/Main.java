package org.practicaltest.question3.main;

import java.util.Scanner;

import org.practicaltest.question3.model.Account;
import org.practicaltest.question3.service.CheckingAccount;
import org.practicaltest.question3.view.SavingsAccount;
...
public class Main {
	    ...
	    public static Account createAccount(Scanner keyboard) {
	        ...
	        if(choice == 1)  { 
	            ...
	            account1 = new CheckingAccount(accountNumber, fee);
	        } else { 
	            
	            System.out.print("Please enter Interest Rate: ");
	            double ir = keyboard.nextDouble();
	            account1 = new SavingsAccount(accountNumber, ir);
	        }
	        return account1;
	    }
